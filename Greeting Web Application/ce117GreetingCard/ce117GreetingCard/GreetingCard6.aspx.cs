...
{
    public partial class GreetingCard6 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                d1 = (DropDownList)Page.PreviousPage.FindControl("lstBackColor");

                d2 = (DropDownList)Page.PreviousPage.FindControl("lstFontName");
                t1 = (TextBox)Page.PreviousPage.FindControl("txtFontSize");

                t2 = (TextBox)Page.PreviousPage.FindControl("txtGreeting");
                r1 = (RadioButtonList)Page.PreviousPage.FindControl("lstBorder");
                c1 = (CheckBox)Page.PreviousPage.FindControl("chkPicture");
