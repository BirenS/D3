<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Version3.aspx.cs" Inherits="Greeting_Web_Application.Smit_ce125.GreetingCardMaker_Version3.Version3" %>
...
<br/>
    <asp:Button ID="Button1" runat="server" Text="Next >" CommandName="NextView" OnClick="Button1_Click"  ></asp:Button>
</asp:View>
...
OnCheckedChanged="ControlChangedPicture" Text="Add the Default Picture" />
    <br/>
    <asp:Button ID="Button2" runat="server" Text="Prev <" CommandName="PrevView" OnClick="Button2_Click" ></asp:Button>
...
<br/>
    <asp:Button ID="Button4" runat="server" Text="Prev <" CommandName="PrevView" OnClick="Button4_Click"  ></asp:Button>
